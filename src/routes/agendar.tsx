...
function AgendarVisita() {
  ...
  if (configLoading) {
    return <div className="min-h-screen bg-[#080808] flex items-center justify-center">
      <div className="w-12 h-12 border-4 border-[#d7f803] border-t-transparent rounded-full animate-spin"></div>
    </div>;
  }

  return (
    <main className="bg-[#080808] text-white min-h-screen font-inter selection:bg-[#d7f803] selection:text-[#080808]">
      {/* HERO SIMPLES */}
            ...
            <div className="text-center py-8 animate-fade-in">
              ...
              <div className="space-y-4 mb-10">
                <p className="text-white text-[17px] leading-relaxed">
                  Perfeito, <span className="text-[#d7f803] font-bold">{formData.nome}</span>! Estamos te esperando em <span className="text-[#d7f803] font-bold">{formData.data.split('-').reverse().join('/')}</span> no horário <span className="text-[#d7f803] font-bold">{formData.horario}</span>.
                </p>
              ...
              <div className="pt-8 border-t border-white/5 space-y-4">
                <div className="flex items-center justify-center gap-2 text-[#666] text-sm">
                  <MapPin className="w-4 h-4 text-[#d7f803]" />
                ...
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="text-[#d7f803] text-sm font-bold underline underline-offset-4"
                >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-2">
                ...
                <input 
                  ...
                  className="w-full bg-[#161616] border border-[#222] rounded-2xl px-6 py-4 text-white placeholder-[#444] focus:border-[#d7f803] focus:ring-[3px] focus:ring-[#d7f803]/10 transition-all outline-none"
                  value={formData.nome}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <input 
                      ...
                      min={minDate}
                      max={maxDate}
                      className="w-full bg-[#161616] border border-[#222] rounded-2xl px-6 py-4 text-white placeholder-[#444] focus:border-[#d7f803] outline-none transition-all"
                      value={formData.data}
                ...
                <div className="space-y-2">
                  ...
                  <select 
                    required
                    className="w-full bg-[#161616] border border-[#222] rounded-2xl px-6 py-4 text-white focus:border-[#d7f803] outline-none transition-all appearance-none"
      ...
      <section className="bg-[#0A0A0A] py-32 px-6">
        <div className="container-custom">
          <div className="text-center mb-20">
            <span className="text-[#d7f803] font-black text-[12px] uppercase tracking-[4px] mb-4 block">EXPERIÊNCIA ELITE+</span>
            <h2 className="font-bebas text-[52px] md:text-[64px] text-white tracking-tighter uppercase">
              O QUE ACONTECE NA <span className="text-[#d7f803]">SUA VISITA</span>
            </h2>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-[#111] border-l-[3px] border-[#d7f803] rounded-2xl p-8 relative overflow-hidden group hover:bg-[#161616] transition-all">
              <span className="font-bebas text-[64px] text-[#d7f803] opacity-10 absolute top-4 right-8 select-none">01</span>
              <div className="bg-[#d7f803]/10 w-16 h-16 rounded-2xl flex items-center justify-center text-[#d7f803] mb-8 group-hover:bg-[#d7f803] group-hover:text-[#0A0A0A] transition-all">
            ...
            <div className="bg-[#111] border-l-[3px] border-[#d7f803] rounded-2xl p-8 relative overflow-hidden group hover:bg-[#161616] transition-all">
              <span className="font-bebas text-[64px] text-[#d7f803] opacity-10 absolute top-4 right-8 select-none">02</span>
              <div className="bg-[#d7f803]/10 w-16 h-16 rounded-2xl flex items-center justify-center text-[#d7f803] mb-8 group-hover:bg-[#d7f803] group-hover:text-[#0A0A0A] transition-all">
            ...
            <div className="bg-[#111] border-l-[3px] border-[#d7f803] rounded-2xl p-8 relative overflow-hidden group hover:bg-[#161616] transition-all">
              <span className="font-bebas text-[64px] text-[#d7f803] opacity-10 absolute top-4 right-8 select-none">03</span>
              <div className="bg-[#d7f803]/10 w-16 h-16 rounded-2xl flex items-center justify-center text-[#d7f803] mb-8 group-hover:bg-[#d7f803] group-hover:text-[#0A0A0A] transition-all">
