...
function Index() {
  ...
  return (
    <main ref={revealRef as any} className="bg-[#080808] text-white min-h-screen selection:bg-[#d7f803] selection:text-[#080808] relative overflow-x-hidden">
      ...
      <section className="relative min-h-[90vh] md:min-h-screen flex flex-col items-center justify-center pt-16 pb-16 px-8 overflow-hidden">
        <div className="absolute inset-0 z-0">
          ...
          <div className="absolute inset-0 bg-radial-at-center from-[#d7f803]/5 to-transparent opacity-30"></div>
        </div>
        ...
        <div className="relative z-10 flex flex-col items-center text-center max-w-5xl w-full reveal">
          ...
          <div className="flex flex-col sm:flex-row gap-5 mb-8 w-full sm:w-auto">
            <button 
              ...
              className="group bg-[#d7f803] text-[#0A0A0A] font-black uppercase tracking-[1px] px-10 py-4 rounded-full transition-all hover:scale-[1.05] hover:shadow-[0_0_50px_rgba(215,248,3,0.4)] text-[16px] active:scale-95 shadow-xl"
            >
              GARANTIR MINHA VAGA
            </button>
          ...
          <div className="grid grid-cols-3 gap-8 md:gap-16 font-bebas text-[18px] md:text-[24px] text-[#555] tracking-widest uppercase">
            <div className="flex flex-col items-center">
              <span className="text-[#d7f803]">05H–22H</span>
      ...
      <div className="relative h-[220px] w-full flex items-center justify-center overflow-hidden bg-[#080808] z-[20] -my-14">
        <div className="relative w-full h-full flex items-center justify-center">
          ...
          <div 
            className="absolute w-[180vw] h-[38px] bg-[#1A1A1A] border-y border-[#d7f803]/20 flex items-center overflow-hidden whitespace-nowrap z-[1]"
            style={{ transform: 'rotate(12deg)' }}
          >
            <div className="flex gap-8 px-4 font-bebas text-[18px] md:text-[22px] text-[#d7f803] tracking-[2px] uppercase animate-marquee-right">
          ...
          <div 
            className="absolute w-[180vw] h-[38px] bg-[#d7f803] flex items-center overflow-hidden whitespace-nowrap z-[2] shadow-[0_0_40px_rgba(0,0,0,0.6)]"
      ...
      <section className="bg-[#080808] py-32 px-8">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-20 reveal">
            <span className="text-[#d7f803] font-poppins text-[12px] font-black uppercase tracking-[4px] mb-4 block">DÚVIDAS</span>
            <h2 className="font-poppins font-black text-[40px] md:text-[60px] leading-[1.1] text-white">
              PERGUNTAS <span className="text-[#d7f803]">FREQUENTES</span>
            </h2>
          </div>
          ...
          <div className="grid gap-4">
            {[
              ...
              <details key={i} className="group bg-[#111] border border-white/5 rounded-[20px] overflow-hidden reveal hover:border-[#d7f803]/20 transition-all">
                <summary className="flex items-center justify-between p-7 cursor-pointer list-none">
                  ...
                  <span className="text-[#d7f803] text-2xl transition-transform duration-300 group-open:rotate-45">+</span>
                </summary>
